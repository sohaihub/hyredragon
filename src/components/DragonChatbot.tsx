...
const DragonChatbot: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      ...
      {isOpen && (
        <div className="bg-[#080820] border-2 border-[#dffc54] rounded-2xl shadow-2xl shadow-black/20 flex flex-col w-96 sm:w-[500px] h-[650px] animate-fade-in overflow-hidden content-box">
